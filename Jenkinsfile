    ...
    stages {
        ...
        stage('SonarQube Analysis') {
            steps{
                ...
                sh "mvn clean verify sonar:sonar -Dsonar.host.url=http://localhost:9091 -Dsonar.login=admin -Dsonar.password=ch@Sonar6292 -Dsonar.projectKey=productservice -Dsonar.projectName='ProductService'"
