    ...
    stages {
        ...
        stage('SonarQube Analysis') {
            steps{
                ...
                sh "mvn clean verify sonar:sonar -Dsonar.login=sqp_806101d50619e82f7a7016b4d39c0c426b8ddd4e -Dsonar.projectKey=productservice -Dsonar.projectName='ProductService'"
